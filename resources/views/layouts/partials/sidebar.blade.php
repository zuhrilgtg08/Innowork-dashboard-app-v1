    ...
    <div class="flex h-full flex-col">
        ...
        <div class="border-t border-gray-200 p-3 dark:border-gray-700">
            <div class="flex items-center gap-3 rounded-xl px-2 py-2">
                <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand-100 text-sm font-bold text-brand-700 dark:bg-brand-600/20 dark:text-brand-300">
                    {{ $user->initials() }}
                </div>
