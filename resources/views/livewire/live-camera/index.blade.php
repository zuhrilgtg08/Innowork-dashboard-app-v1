            ...
            <div class="card overflow-hidden"
                ...
                <div class="relative aspect-video bg-gray-900">
                    ...
                    <div x-show="!active" class="absolute inset-0 flex flex-col items-center justify-center gap-3 text-gray-500">
                        ...
                        <button @click="start()" x-show="!error" class="rounded-lg bg-brand-600 px-4 py-2 text-xs font-semibold text-white hover:bg-brand-700">Aktifkan Kamera</button>
                    </div>
                ...
                <div class="flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex gap-2">
                        <button @click="capture()" x-show="active" :disabled="uploading"
                        ...
                        <button @click="start()" x-show="!active" class="rounded-lg bg-brand-600 px-4 py-2 text-xs font-semibold text-white hover:bg-brand-700">Start</button>
                        <button @click="stop()" x-show="active" class="rounded-lg bg-gray-100 px-4 py-2 text-xs font-semibold text-gray-600 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600">Stop</button>
                    </div>
                </div>
            </div>
